  ...
  return (
    <div className="flex min-h-screen">
      ...
      >
        ...
        <div className="p-4 border">
          ...
          <div className="relative">
            ...
            <NSInput placeholder="Search messages" className="pl-10" />
          </div>
        </div>
          ...
          <div className="p-2">
            {contacts.map((contact, index) => (
              <motion.div
                ...
                className={cn(
                  "flex items-center gap-3 p-3 rounded-lg cursor-pointer transition-colors hover:bg-green-50",
      ...
      <div className="flex-1 flex flex-col">
        ...
        {/* Messages */}
        <ScrollArea className="flex-1 p-4 border">
                ...
                >
                  ...
                  <div
                    className={cn(
                      ...
                      message.sent
                        ? "text-primary-foreground rounded-br-md bg-[#54B18D]"
                        : "rounded-bl-md bg-[#54B18D] text-primary-foreground"
                    )}
                  >
